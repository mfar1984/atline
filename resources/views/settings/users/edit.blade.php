...
<div class="bg-white border border-gray-200">
    ...
    <div class="px-6 py-4 flex items-center justify-between border-b border-gray-100">
        <div>
            <h2 class="text-sm font-semibold text-gray-900" style="font-family: Poppins, sans-serif;">Edit User</h2>
            <p class="text-xs text-gray-500 mt-0.5" style="font-size: 11px;">Update user information</p>
        </div>
    ...
    <!-- Form -->
    <form id="user-form" action="{{ route('settings.users.update', $user) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="p-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="border border-gray-200 rounded">
                    ...
                    <div class="p-4 space-y-4">
                        ...
                        <div class="pt-2">
                            <p class="text-xs text-gray-500" style="font-size: 10px;">Leave blank to keep current password. Minimum {{ $passwordMinLength }} characters if changing.</p>
                        </div>
                    </div>
                </div>
            </div>
