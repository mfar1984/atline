<div x-data="{ showForm: false, editId: null, editData: {}, step: 1 }"
     x-on:edit-vendor.window="editId = $event.detail.id; editData = $event.detail.data; step = 1; showForm = true">
    <!-- Header with Add Button -->
    <div class="flex items-center justify-between mb-4">
        <h3 class="text-sm font-semibold text-gray-900" style="font-family: Poppins, sans-serif;">Vendor List</h3>
        @permission('external_settings_vendor.create')
        <button @click="showForm = true; editId = null; editData = { country: 'Malaysia' }; step = 1" 
        ...
        <form action="{{ route('external.settings.index') }}" method="GET" class="flex items-center gap-2">
            ...
            <div class="flex-1">
                <input type="text" name="search" value="{{ request('search') }}" 
                       placeholder="Search name, phone, incharge..." 
            ...
            <button type="button" onclick="window.location.href='{{ route('external.settings.index', ['tab' => 'vendors']) }}'" class="inline-flex items-center gap-2 px-3 text-white text-xs font-medium rounded transition" style="min-height: 32px; background-color: #dc2626;">
            ...
            <div style="padding: 16px 20px !important; border-bottom: 1px solid #e5e7eb !important; display: flex !important; align-items: center !important; justify-content: space-between !important; background-color: #f9fafb !important;">
                <div style="display: flex !important; align-items: center !important; gap: 10px !important;">
                    <div style="width: 36px !important; height: 36px !important; border-radius: 8px !important; background-color: #6366f1 !important; display: flex !important; align-items: center !important; justify-content: center !important;">
                        <span class="material-symbols-outlined" style="font-size: 20px !important; color: #ffffff !important;">store</span>
                    </div>
                    <h3 style="font-size: 14px !important; font-weight: 600 !important; color: #111827 !important; font-family: Poppins, sans-serif !important; margin: 0 !important;" x-text="editId ? 'Edit Vendor' : 'Add New Vendor'"></h3>
                </div>
            ...
            <div class="py-3 px-5 border-b border-gray-100 bg-white">
                <div class="flex items-center justify-center gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs" :class="step >= 1 ? 'text-blue-500 font-medium' : 'text-gray-400'">Vendor Info</span>
                    </div>
                    <!-- Line -->
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs" :class="step >= 2 ? 'text-blue-500 font-medium' : 'text-gray-400'">Incharge Info</span>
                    </div>
                </div>
            </div>

            <form :action="editId ? '/external/settings/vendors/' + editId : '{{ route('external.settings.vendors.store') }}'" method="POST">
                @csrf
                ...
                <!-- Step 2: Incharge Info -->
                <div x-show="step === 2" style="padding: 20px !important;">
                    <div style="display: flex !important; flex-direction: column !important; gap: 16px !important;">
                        <div style="display: grid !important; grid-template-columns: 1fr 1fr !important; gap: 12px !important;">
                            <div>
                                <label style="display: block !important; font-size: 11px !important; font-weight: 500 !important; color: #374151 !important; margin-bottom: 6px !important; font-family: Poppins, sans-serif !important;">Full Name</label>
                                <input type="text" name="incharge_name" x-model="editData.incharge_name"
                                       style="width: 100% !important; padding: 10px 12px !important; border: 1px solid #d1d5db !important; border-radius: 6px !important; font-family: Poppins, sans-serif !important; font-size: 12px !important; color: #1f2937 !important; outline: none !important;"
                            ...
                            <div>
                                <label style="display: block !important; font-size: 11px !important; font-weight: 500 !important; color: #374151 !important; margin-bottom: 6px !important; font-family: Poppins, sans-serif !important;">Phone Number</label>
                                <input type="text" name="incharge_phone" x-model="editData.incharge_phone"
                                       style="width: 100% !important; padding: 10px 12px !important; border: 1px solid #d1d5db !important; border-radius: 6px !important; font-family: Poppins, sans-serif !important; font-size: 12px !important; color: #1f2937 !important; outline: none !important;"
                                       placeholder="Enter phone number"
                                       onfocus="this.style.borderColor='#3b82f6'" onblur="this.style.borderColor='#d1d5db'">
                            </div>
                        ...
                        <div style="display: grid !important; grid-template-columns: 1fr 1fr !important; gap: 12px !important;">
                            <div>
                                <label style="display: block !important; font-size: 11px !important; font-weight: 500 !important; color: #374151 !important; margin-bottom: 6px !important; font-family: Poppins, sans-serif !important;">WhatsApp Number</label>
                                <input type="text" name="incharge_whatsapp" x-model="editData.incharge_whatsapp"
                                       style="width: 100% !important; padding: 10px 12px !important; border: 1px solid #d1d5db !important; border-radius: 6px !important; font-family: Poppins, sans-serif !important; font-size: 12px !important; color: #1f2937 !important; outline: none !important;"
                            ...
                            <div>
                                ...
                                <input type="email" name="incharge_email" x-model="editData.incharge_email"
                                       style="width: 100% !important; padding: 10px 12px !important; border: 1px solid #d1d5db !important; border-radius: 6px !important; font-family: Poppins, sans-serif !important; font-size: 12px !important; color: #1f2937 !important; outline: none !important;"
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" style="font-size: 10px;">Incharge</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="{{ !$vendor->is_active ? 'opacity-50' : '' }}">
                    <td class="px-4 py-3 text-xs text-gray-900" style="font-family: Poppins, sans-serif;">{{ $vendor->name }}</td>
                    <td class="px-4 py-3 text-xs text-gray-600" style="font-family: Poppins, sans-serif;">
                        @if($vendor->organization_type)
                            {{ $vendor->organization_type == 'ngo' ? 'NGO' : 'Company' }}
                        @else
                            -
                        @endif
                    </td>
                    <td class="px-4 py-3 text-xs text-gray-600" style="font-family: Poppins, sans-serif;">{{ $vendor->incharge_name ?? '-' }}</td>
                    <td class="px-4 py-3 text-xs text-gray-600" style="font-family: Poppins, sans-serif;">{{ $vendor->phone ?? '-' }}</td>
                    <td class="px-4 py-3 text-xs text-gray-600" style="font-family: Poppins, sans-serif;">{{ $vendor->created_at?->format('d/m/Y') ?? '-' }}</td>
                    <td class="px-4 py-3 text-xs text-gray-600" style="font-family: Poppins, sans-serif;">{{ $vendor->updated_at?->format('d/m/Y') ?? '-' }}</td>
                    <td class="px-4 py-3 text-center">
                        <span class="status-badge inline-flex px-2 py-1 text-xs font-medium rounded {{ $vendor->is_active ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-600' }}" style="font-size: 10px;">
                            {{ $vendor->is_active ? 'Active' : 'Inactive' }}
                        </span>
                    </td>
                    <td class="px-4 py-3 text-center">
                        <x-ui.action-buttons
                            :edit-onclick="auth()->user()->hasPermission('external_settings_vendor.update') ? 'editVendor(' . $vendor->id . ', ' . json_encode([
                                'name' => $vendor->name,
                                ...
                                'state' => $vendor->state ?? '',
                                'country' => $vendor->country ?? 'Malaysia',
                                'website' => $vendor->website ?? '',
                                'phone' => $vendor->phone ?? '',
                                'incharge_name' => $vendor->incharge_name ?? '',
                                'incharge_phone' => $vendor->incharge_phone ?? '',
                                'incharge_whatsapp' => $vendor->incharge_whatsapp ?? '',
                                'incharge_email' => $vendor->incharge_email ?? ''
                            ]) . ')' : null"
                            :delete-onclick="auth()->user()->hasPermission('external_settings_vendor.delete') ? 'deleteVendor(' . $vendor->id . ')' : null"
                            :more-actions="auth()->user()->hasPermission('external_settings_vendor.update') ? [
                                ['label' => $vendor->is_active ? 'Deactivate' : 'Activate', 'icon' => $vendor->is_active ? 'toggle_off' : 'toggle_on', 'onclick' => 'toggleStatus(\'vendors\', ' . $vendor->id . ', this)']
                            ] : []"
                        />
                        <form id="delete-vendor-{{ $vendor->id }}" action="{{ route('external.settings.vendors.destroy', $vendor) }}" method="POST" class="hidden">
                            @csrf
                            @method('DELETE')
                        </form>
                    </td>
                ...
                @empty
                <tr>
                    <td colspan="8" class="px-4 py-8 text-center text-gray-500 text-xs">No vendors found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <!-- Pagination -->
    <div class="mt-4">
        <x-ui.custom-pagination :paginator="$vendors" record-label="vendors" />
    </div>
</div>
