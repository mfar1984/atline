...
<div style="background-color: #ffffff; border: 1px solid #e5e7eb;">
    ...
    <div style="padding: 16px 24px; border-bottom: 1px solid #e5e7eb;">
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <div>
                <h2 style="font-size: 16px; font-weight: 600; color: #111827; margin: 0; font-family: Poppins, sans-serif;">Add New Employee</h2>
                <p style="font-size: 12px; color: #6b7280; margin-top: 4px;">Complete all steps to register a new employee</p>
            </div>
    ...
    <div style="padding: 24px;">
        ...
        <form id="employeeForm" action="{{ route('internal.employee.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div style="background-color: #f9fafb; border-radius: 8px; padding: 24px; border: 1px solid #f3f4f6;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px;">
                        <div>
                            ...
                            <input type="text" name="current_postcode"
                                   style="width: 100%; padding: 0 12px; min-height: 32px; font-size: 11px; border: 1px solid #d1d5db; border-radius: 4px; outline: none;"
                        ...
                        <div>
                            ...
                            <input type="text" name="current_country" value="Malaysia"
                                   style="width: 100%; padding: 0 12px; min-height: 32px; font-size: 11px; border: 1px solid #d1d5db; border-radius: 4px; outline: none;">
                        </div>
                    </div>
                    ...
                    <div id="correspondenceFields">
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-bottom: 16px;">
                            <div>
                                <label style="display: block; font-size: 11px; font-weight: 500; color: #374151; margin-bottom: 4px;">Address Line 1</label>
                                <input type="text" name="correspondence_address_1" id="corr_address_1"
                                       style="width: 100%; padding: 0 12px; min-height: 32px; font-size: 11px; border: 1px solid #d1d5db; border-radius: 4px; outline: none;">
                            </div>
                            <div>
                                <label style="display: block; font-size: 11px; font-weight: 500; color: #374151; margin-bottom: 4px;">Address Line 2</label>
                                <input type="text" name="correspondence_address_2" id="corr_address_2"
                                       style="width: 100%; padding: 0 12px; min-height: 32px; font-size: 11px; border: 1px solid #d1d5db; border-radius: 4px; outline: none;">
                            </div>
                        </div>
                        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px;">
                            <div>
                                <label style="display: block; font-size: 11px; font-weight: 500; color: #374151; margin-bottom: 4px;">Postcode</label>
                                <input type="text" name="correspondence_postcode" id="corr_postcode"
                                       style="width: 100%; padding: 0 12px; min-height: 32px; font-size: 11px; border: 1px solid #d1d5db; border-radius: 4px; outline: none;">
                            </div>
                            <div>
                                <label style="display: block; font-size: 11px; font-weight: 500; color: #374151; margin-bottom: 4px;">District</label>
                                <input type="text" name="correspondence_district" id="corr_district"
                                       style="width: 100%; padding: 0 12px; min-height: 32px; font-size: 11px; border: 1px solid #d1d5db; border-radius: 4px; outline: none;">
                            </div>
                            <div>
                                <label style="display: block; font-size: 11px; font-weight: 500; color: #374151; margin-bottom: 4px;">State</label>
                            ...
                            <div>
                                <label style="display: block; font-size: 11px; font-weight: 500; color: #374151; margin-bottom: 4px;">Country</label>
                                <input type="text" name="correspondence_country" id="corr_country" value="Malaysia"
                                       style="width: 100%; padding: 0 12px; min-height: 32px; font-size: 11px; border: 1px solid #d1d5db; border-radius: 4px; outline: none;">
                            </div>
                        </div>
                    </div>
                ...
                <div style="background-color: #f9fafb; border-radius: 8px; padding: 24px; border: 1px solid #f3f4f6;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px;">
                        ...
                        <div>
                            ...
                            <input type="text" name="emergency_telephone"
                                   style="width: 100%; padding: 0 12px; min-height: 32px; font-size: 11px; border: 1px solid #d1d5db; border-radius: 4px; outline: none;"
                                   placeholder="e.g., 012-3456789">
                        </div>
                        <div>
            ...
            <div class="step-content" id="step-3" style="display: none;">
                <div style="background-color: #f9fafb; border-radius: 8px; padding: 24px; border: 1px solid #f3f4f6;">
                    ...
                    <div id="noEducation" style="text-align: center; padding: 40px 0; color: #9ca3af;">
                ...
                <div style="background-color: #f9fafb; border-radius: 8px; padding: 24px; border: 1px solid #f3f4f6;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px;">
                        ...
                        <div>
                            ...
                            <input type="text" name="time_works"
                                   style="width: 100%; padding: 0 12px; min-height: 32px; font-size: 11px; border: 1px solid #d1d5db; border-radius: 4px; outline: none;"
...
document.getElementById('existingUserId').addEventListener('change', function() {
    ...
    const html = `
        <div class="education-entry" id="education-${educationCount}" style="background-color: white; border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin-bottom: 16px;">
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px;">
                <span style="font-size: 12px; font-weight: 600; color: #374151;">Education #${educationCount}</span>
